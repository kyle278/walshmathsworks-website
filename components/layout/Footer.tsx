...
const quickLinks = [
  ...
  { href: "/book/group-a", label: "Book Group A" },
  { href: "/book/group-b", label: "Book Group B" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl">Walsh Maths Works</span>
            </div>
            <p className="text-slate-400 text-sm leading-relaxed mb-4">
              Expert Leaving Cert Maths tuition in Carlow with over 25 years of
              experience and a 100% student success rate.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider mb-4 text-slate-400">
              Quick Links
            </h3>
      ...
      <div className="border-t border-white/10">
        <Container className="py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-slate-400">
            &copy; {siteConfig.year} Walsh Maths Works. All rights reserved.
          </p>
